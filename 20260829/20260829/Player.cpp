...
void Player::Move(float deltaTime)
{
	...
	{
		velocityX -= Config::PLAYER_ACCEL * deltaTime;
		animationType = 1;
	}
	...
	if (velocityX > Config::PLAYER_MAX_SPEED)
	{
	...
	{
		velocityX *= Config::PLAYER_FRICTION;
	}
	...
	bool jumpButton = CheckHitKey(KEY_INPUT_SPACE);

	if (jumpButton && !previousJump && groundFlag)
	{
		velocityX = -Config::JUMP_POWER;
